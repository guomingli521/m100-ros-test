...
if("TRUE" STREQUAL "TRUE")
  set(dji_sdk_SOURCE_PREFIX /home/ubuntu/m100-ros-test/workspace/src/dji_sdk)
  set(dji_sdk_DEVEL_PREFIX /home/ubuntu/m100-ros-test/workspace/devel)
  set(dji_sdk_INSTALL_PREFIX "")
  set(dji_sdk_PREFIX ${dji_sdk_DEVEL_PREFIX})
else()
  set(dji_sdk_SOURCE_PREFIX "")
  set(dji_sdk_DEVEL_PREFIX "")
  set(dji_sdk_INSTALL_PREFIX /home/ubuntu/m100-ros-test/workspace/install)
...
if(NOT "/home/ubuntu/m100-ros-test/workspace/devel/include;/home/ubuntu/m100-ros-test/workspace/src/dji_sdk/include " STREQUAL " ")
  set(dji_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/m100-ros-test/workspace/devel/include;/home/ubuntu/m100-ros-test/workspace/src/dji_sdk/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/m100-ros-test/workspace/src/dji_sdk/${idir}'.  Ask the maintainer 'Norman Li <norman.li@dji.com>, Botao Hu <me@botao.hu>' to fix it.")
    endif()
...
set(dji_sdk_EXPORTED_TARGETS "dji_sdk_generate_messages_cpp;dji_sdk_generate_messages_lisp;dji_sdk_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${dji_sdk_dep}_FOUND)
      find_package(${dji_sdk_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${dji_sdk_dep} REQUIRED ${depend_list})
  endif()
